...
int enginetest (int argcount,char **argvalue){
    ...
    /*start time*/
    begintime= static_cast<int>(clock());  /*20181119 shengyi*/
    ...
    fn_ws_mgc = (char **) calloc(static_cast<size_t>(argcount), sizeof(char *));
    /* delta window handler for log f0 */
    fn_ws_lf0 = (char **) calloc(static_cast<size_t>(argcount), sizeof(char *));
    /* delta window handler for low-pass filter */
    fn_ws_lpf = (char **) calloc(static_cast<size_t>(argcount), sizeof(char *));

    /* prepare for interpolation */
    num_interp = GetNumInterp(argcount, argvalue);
    rate_interp = (double *) calloc(static_cast<size_t>(num_interp), sizeof(double));
    for (i = 0; i < num_interp; i++)
        rate_interp[i] = 1.0;

    fn_ms_dur = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_mgc = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_lf0 = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_lpf = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_dur = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_mgc = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_lf0 = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_lpf = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_gvm = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_gvl = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ms_gvf = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_gvm = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_gvl = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
    fn_ts_gvf = (char **) calloc(static_cast<size_t>(num_interp), sizeof(char *));
        ...
        if (**++argvalue == '-') {
            switch (*(*argvalue + 1)) {
                case 'v':
                    switch (*(*argvalue + 2)) {
                        case 'p':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-v%c'.\n"), *(*argvalue + 2));
                    }
                    break;
                case 't':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-t%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'm':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-m%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'd':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-d%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'o':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 't':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-o%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'h':
                ...
                case 'f':
                    switch (*(*argvalue + 2)) {
                        case 'm':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-f%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'u':
                ...
                case 'e':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-e%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'c':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-c%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'j':
                    switch (*(*argvalue + 2)) {
                        ...
                        case 'l':
                            ...
                            break;
                        default:
                            Error(1, const_cast<char *>("hts_engine: Invalid option '-j%c'.\n"), *(*argvalue + 2));
                    }
                    --argcount;
                    break;
                case 'k':
                ...
                case 'z':
                    ...
                    break;
                default:
                    Error(1, const_cast<char *>("hts_engine: Invalid option '-%c'.\n"), *(*argvalue + 1));
            }
        } else {
            labfn = *argvalue;
        }
    ...
    if (num_interp != num_ts_dur || num_interp != num_ts_mgc || num_interp != num_ts_lf0 || num_interp != num_ms_dur || num_interp != num_ms_mgc || num_interp != num_ms_lf0) {
        Error(1, const_cast<char *>("hts_engine: specify %d models(trees) for each parameter.\n"), num_interp);
    }
    if (num_ms_lpf > 0 || num_ts_lpf > 0) {
        if (num_interp != num_ms_lpf || num_interp != num_ts_lpf) {
            Error(1,
                  const_cast<char *>("hts_engine: specify %d models(trees) for each parameter.\n"), num_interp);
        }
    }
    ...
    endtime = static_cast<int>(clock());/*20181119 shengyi*/
...
Java_com_example_user_hellooboe_PlaybackEngine_HtsEngine
    ...
    tmp[12] = const_cast<char *>("/storage/emulated/0/voice/tree-lf0.inf");
    tmp[13] = const_cast<char *>("-tm");
    tmp[14] = const_cast<char *>("/storage/emulated/0/voice/tree-mgc.inf");
    tmp[15] = const_cast<char *>("-tl");
    tmp[16] = const_cast<char *>("/storage/emulated/0/voice/tree-lpf.inf");
    tmp[17] = const_cast<char *>("-md");
    tmp[18] = const_cast<char *>("/storage/emulated/0/voice/dur.pdf");
    tmp[19] = const_cast<char *>("-mf");
    tmp[20] = const_cast<char *>("/storage/emulated/0/voice/lf0.pdf");
    tmp[21] = const_cast<char *>("-mm");
    tmp[22] = const_cast<char *>("/storage/emulated/0/voice/mgc.pdf");
    tmp[23] = const_cast<char *>("-ml");
    tmp[24] = const_cast<char *>("/storage/emulated/0/voice/lpf.pdf");
    tmp[25] = const_cast<char *>("-df");
    tmp[26] = const_cast<char *>("/storage/emulated/0/voice/lf0.win1");
    tmp[27] = const_cast<char *>("-df");
    tmp[28] = const_cast<char *>("/storage/emulated/0/voice/lf0.win2");
    tmp[29] = const_cast<char *>("-df");
    tmp[30] = const_cast<char *>("/storage/emulated/0/voice/lf0.win3");
    tmp[31] = const_cast<char *>("-dm");
    tmp[32] = const_cast<char *>("/storage/emulated/0/voice/mgc.win1");
    tmp[33] = const_cast<char *>("-dm");
    tmp[34] = const_cast<char *>("/storage/emulated/0/voice/mgc.win2");
    tmp[35] = const_cast<char *>("-dm");
    tmp[36] = const_cast<char *>("/storage/emulated/0/voice/mgc.win3");
    tmp[37] = const_cast<char *>("-dl");
    tmp[38] = const_cast<char *>("/storage/emulated/0/voice/lpf.win1");
    tmp[39] = const_cast<char *>("-k");
    tmp[40] = const_cast<char *>("/storage/emulated/0/voice/gv-switch.inf");
    tmp[41] = const_cast<char *>("-b");
    tmp[42] = const_cast<char *>("0.0");
    tmp[43] = const_cast<char *>("-ow");
    tmp[44] = const_cast<char *>("/storage/emulated/0/output.wav");
    tmp[45] = const_cast<char *>("/storage/emulated/0/input.xlab");
...
Java_com_example_user_hellooboe_PlaybackEngine_native_1createEngine(
        JNIEnv *env,
        jclass /*unused*/) {
...
Java_com_example_user_hellooboe_PlaybackEngine_native_1deleteEngine(
        JNIEnv *env,
        jclass,
        jlong engineHandle) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setToneOn(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
        jboolean isToneOn) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setAudioApi(
        JNIEnv *env,
        jclass type,
        jlong engineHandle,
        jint audioApi) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setAudioDeviceId(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
        jint deviceId) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setChannelCount(
        JNIEnv *env,
        jclass type,
        jlong engineHandle,
        jint channelCount) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setBufferSizeInBursts(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
...
Java_com_example_user_hellooboe_PlaybackEngine_native_1getCurrentOutputLatencyMillis(
        JNIEnv *env,
        jclass,
        jlong engineHandle) {
...
Java_com_example_user_hellooboe_PlaybackEngine_native_1isLatencyDetectionSupported(
        JNIEnv *env,
        jclass type,
        jlong engineHandle) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setDefaultSampleRate(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jint sampleRate) {
...
JNIEXPORT void JNICALL
Java_com_example_user_hellooboe_PlaybackEngine_native_1setDefaultFramesPerBurst(JNIEnv *env,
                                                                                      jclass type,
                                                                                      jint framesPerBurst) {
